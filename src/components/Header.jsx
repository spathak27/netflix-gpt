...
const Header = () => {
  ...
  return (
    <div
     ...
     px-8 py-5 md:bg-gradient-to-b md:from-black z-10 flex flex-col md:flex-row justify-between"
    >
      <img className="w-50 mx-auto md:mx-0" src={APP_LOGO} alt="app-logo"></img>
      {user && (
